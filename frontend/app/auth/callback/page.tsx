...
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
    async function confirmEmailAndRedirect() {
      try {
        ...
        const profile = await apiRequest<AuthResponse>("/me");
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-app-chantilly px-4 text-app-cafe-profundo">
