      ...
      <section className="mx-auto w-full max-w-5xl flex-1 px-5 py-10 sm:py-14">
        ...
        <section className="mt-8 rounded-[8px] bg-app-creme-leve p-6 shadow-sm ring-1 ring-app-baunilha-dourada/60 sm:p-8">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              type="button"
              className="flex h-10 w-10 items-center justify-center rounded-[8px] text-app-cinza transition hover:bg-app-baunilha-dourada hover:text-app-cafe-profundo"
        ...
        <section className="mt-7 grid gap-5">
          {settingsItems.map((item) => (
            ...
            >
              ...
              <Icon
                type="chevron-right"
                className="mt-4 h-5 w-5 text-app-baunilha-dourada sm:mt-0"
              />
            </Link>
          ))}
        </section>
