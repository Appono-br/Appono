...
function PedidoSkeleton() {
    return <div className="h-36 animate-pulse rounded-[14px] bg-app-creme-leve ring-1 ring-app-baunilha-dourada/60" />;
}
        ...
        <main className="min-h-screen bg-app-chantilly px-5 py-10 text-app-cafe-profundo">
            <section className="mx-auto max-w-6xl">
                ...
                {!carregando && !erro && !pedidos.length ? (
                    <div className="mt-8 rounded-[14px] border border-dashed border-app-baunilha-dourada bg-app-creme-leve p-10 text-center">
                ...
                {!carregando && pedidos.length ? (
                    <div className="mt-8 grid gap-4 sm:grid-cols-2">
                        {pedidos.map((pedido) => (
                            <article key={pedido.id_pedido} className="rounded-[14px] bg-app-creme-leve p-5 shadow-sm ring-1 ring-app-baunilha-dourada/70">
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <span className="rounded-full bg-app-chantilly px-3 py-1 text-xs font-bold ring-1 ring-app-baunilha-dourada">{textoStatusPedido(pedido.status_pedido)}</span>
                                </div>
