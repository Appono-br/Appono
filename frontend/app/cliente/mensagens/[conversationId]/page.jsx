    ...
    <main className="flex min-h-screen flex-col bg-white text-app-cafe-profundo">
      ...
      <section className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-5 py-8">
        ...
        <form onSubmit={enviarMensagem} className="mt-5 flex items-center gap-3 rounded-[16px] bg-white p-3 shadow-sm ring-1 ring-app-baunilha-dourada/60 transition focus-within:ring-app-caramelo-torrado">
          <textarea value={draft} onChange={(event) => setDraft(event.target.value)} onKeyDown={enviarComEnter} maxLength={1200} placeholder={ui("Escreva sua mensagem...")} className="h-12 flex-1 resize-none bg-transparent px-2 py-3 text-sm leading-6 outline-none placeholder:text-app-cinza/60" />
