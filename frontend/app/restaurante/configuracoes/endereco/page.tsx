...
function Icon({
  ...
  type: "arrow-left" | "chevron-down" | "help" | "map-pin" | "navigation";
  className?: string;
}) {
  const paths = {
  ...
  return (
    <label className={`grid gap-2 ${className}`}>
      ...
      <input
        ...
        className="h-12 border-b border-app-cinza/70 bg-transparent px-3 text-base text-app-cafe-profundo outline-none transition placeholder:text-app-cinza/55 focus:border-app-caramelo-torrado"
      />
    </label>
  );
}
  ...
  return (
    <main className="flex min-h-screen flex-col bg-app-chantilly text-app-cafe-profundo">
      ...
      <section className="mx-auto grid w-full max-w-7xl flex-1 gap-8 px-5 py-10 lg:grid-cols-[1fr_0.7fr] lg:items-start">
        <form
          onSubmit={submitForm}
          className="rounded-[8px] bg-app-chantilly p-6 shadow-sm ring-1 ring-app-baunilha-dourada/45 sm:p-10"
        >
            ...
            <label className="grid gap-2">
              ...
              <span className="relative">
                <select
                  ...
                  className="h-12 w-full appearance-none rounded-[8px] border border-app-baunilha-dourada bg-app-creme-suave px-4 pr-10 text-base text-app-cafe-profundo outline-none transition focus:border-app-caramelo-torrado focus:ring-2 focus:ring-app-dourado-mel/20"
                >
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <Link
              href="/restaurante/configuracoes"
              className="flex h-12 items-center justify-center rounded-[8px] border border-app-mocha px-8 text-xs font-bold uppercase tracking-wide text-app-mocha transition hover:bg-app-creme-leve"
            >
              Cancelar
            </Link>
          </div>
          ...
          {message ? (
            <p className="mt-4 text-sm font-semibold text-app-caramelo-torrado">
              {message}
            </p>
          ) : null}
        </form>
