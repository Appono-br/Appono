...
function Icon({
  ...
  const paths = {
    ...
    shield:
      "M12 21s7-3.2 7-9.8V5l-7-3-7 3v6.2C5 17.8 12 21 12 21z",
    store:
      "M4 10h16l-1-5H5l-1 5z M6 10v10h12V10M9 20v-6h6v6",
  };
    ...
    <main className="flex min-h-screen flex-col bg-app-chantilly text-app-cafe-profundo">
      ...
      <section className="mx-auto w-full max-w-7xl flex-1 px-5 py-10 sm:py-14">
        <div className="grid gap-8 lg:grid-cols-[0.42fr_1fr]">
          ...
          <form
            onSubmit={submitForm}
            className="rounded-[8px] bg-app-chantilly p-6 shadow-sm ring-1 ring-app-baunilha-dourada/45 sm:p-8"
          >
            <div className="flex flex-col gap-6 border-b border-app-baunilha-dourada/60 pb-7 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="grid w-full max-w-xs grid-cols-2 rounded-[8px] bg-app-creme-suave p-1 text-center text-xs font-bold uppercase text-app-mocha">
                <button
                  type="button"
                  className="rounded-[8px] bg-app-cafe-profundo px-4 py-3 text-app-creme-leve"
                >
                  PJ (CNPJ)
                </button>
        ...
        <section className="mx-auto mt-10 max-w-4xl rounded-[8px] bg-app-creme-suave p-6 shadow-sm ring-1 ring-app-baunilha-dourada/60 sm:p-8">
          <div className="grid gap-6 sm:grid-cols-[180px_1fr] sm:items-center">
            ...
            <div>
              ...
              <button
                type="button"
                className="mt-5 text-xs font-bold uppercase tracking-[0.18em] text-app-caramelo-torrado transition hover:text-app-cafe-profundo"
              >
                Falar com consultor
              </button>
            </div>
