    ...
    return (<main className="flex min-h-screen flex-col bg-white text-app-cafe-profundo">
      ...
      <section className="mx-auto w-full max-w-7xl flex-1 px-5 py-10 sm:py-14">
        <div className="border-t border-app-baunilha-dourada/60 pt-10">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-app-caramelo-torrado">{ui("Controle administrativo")}</p>
          <h2 className="mt-3 text-4xl font-medium leading-tight text-app-cafe-profundo sm:text-5xl">{ui("Segurança e Acesso")}</h2>
          <p className="mt-4 max-w-3xl text-sm leading-6 text-app-cinza sm:text-base">{ui("Proteja a conta do restaurante, convide pessoas da equipe e limite acoes sensiveis por perfil de trabalho.")}</p>
        </div>
            ...
            <section className="rounded-[8px] bg-app-creme-leve p-6 shadow-sm ring-1 ring-app-baunilha-dourada/60 sm:p-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-app-cinza">{ui("A senha não fica salva no rascunho local.")}</p>
                </div>
              </div>
