...
function EmptyPanel({
  ...
  return (
    <div
      className={`rounded-[8px] border border-dashed border-app-caramelo-torrado/30 px-6 py-8 ${
        tone === "warm" ? "bg-app-creme-suave" : "bg-app-chantilly"
      }`}
    >
...
function ScoreCategory({ label }: { label: string }) {
  return (
    <article className="rounded-[8px] bg-app-creme-leve p-6 shadow-sm ring-1 ring-app-baunilha-dourada/60">
      ...
      <header className="sticky top-0 z-30 border-b border-app-baunilha-dourada/50 bg-transparent text-app-cafe-profundo backdrop-blur-sm">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:h-24">
          ...
          <button
            ...
            aria-controls="restaurant-performance-menu"
          >
            <Icon type="menu" />
          </button>
        </div>
        ...
        {mobileMenuOpen ? (
          <nav
            id="restaurant-performance-menu"
          ...
          <article className="rounded-[8px] bg-app-chantilly p-7 shadow-sm ring-1 ring-app-baunilha-dourada/45 sm:p-8">
            ...
            <div className="mt-6 flex gap-1 text-app-caramelo-torrado">
              {Array.from({ length: 5 }).map((_, index) => (
                <Icon key={index} type="star" className="h-6 w-6" />
              ))}
            </div>
        ...
        <section className="mt-8 rounded-[8px] bg-app-creme-suave p-6 shadow-sm ring-1 ring-app-baunilha-dourada/60 sm:p-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            <section>
              ...
              <div className="mt-5">
                <EmptyPanel
                  title="Nenhum destaque registrado"
                  description="Os principais elogios aparecerao aqui."
                />
              </div>
            </section>
            ...
            <section>
              ...
              <div className="mt-5">
                <EmptyPanel
                  title="Nenhum ponto de atencao"
                  description="Observacoes importantes aparecerao aqui."
                />
              </div>
            </section>
          </div>
