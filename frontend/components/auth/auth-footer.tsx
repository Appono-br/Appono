...
export function AuthFooter({ dark = false, compact = false }: AuthFooterProps) {
  return (
    <footer
      className={
        dark
    ...
    >
      <div
        className={`mx-auto flex max-w-7xl flex-col px-6 md:flex-row md:items-center md:justify-between ${
        ...
        <Link href="/" className="group w-fit">
          <Image
            ...
            className={`transition duration-300 group-hover:scale-105 ${
              ...
              dark ? "brightness-0 invert sepia" : ""
            }`}
          />
        </Link>

        <nav
          className={`flex flex-col font-semibold uppercase tracking-[0.28em] md:flex-row md:items-center ${
            compact ? "gap-3 md:gap-8" : "gap-4 md:gap-12"
