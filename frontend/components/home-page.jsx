...
>
  ...
  <button
    ...
    className="group relative flex items-center gap-4 rounded-xl bg-app-creme-suave p-4 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
  >
