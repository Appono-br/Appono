alter table public.restaurantes
  add column if not exists valor_minimo_reserva_por_pessoa numeric(10, 2) not null default 0
  check (valor_minimo_reserva_por_pessoa >= 0);

alter table public.reservas
  add column if not exists valor_minimo_por_pessoa numeric(10, 2) not null default 0
  check (valor_minimo_por_pessoa >= 0),
  add column if not exists valor_minimo_total numeric(10, 2) not null default 0
  check (valor_minimo_total >= 0);
