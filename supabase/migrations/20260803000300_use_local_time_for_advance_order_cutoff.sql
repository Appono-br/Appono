...
begin
  ...
  select
    ...
    sum(coalesce(produto.tempo_preparo_minutos, 30) * solicitado.quantidade)::integer
  into valor_calculado, tempo_total_preparo
  ...
  values (
    ...
    reserva_selecionada.data_reserva + reserva_selecionada.horario_inicio
      - make_interval(mins => tempo_total_preparo)
  )
